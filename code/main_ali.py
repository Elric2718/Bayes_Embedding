...
if __name__ == "__main__":
    ...
    if train_or_pred == "train":        
        ...
        id_path = pickle_path + "_id.txt" # "/wiki_id.txt"
        input1_path = pickle_path + "_raw_dat1.csv" #"/wiki_raw_dat1.csv"
        input2_path = pickle_path + "_raw_dat2.csv" #"/wiki_raw_dat2.csv"
    ...
    if train_or_pred == "train":
        ...
        with tf.device("/cpu:0"):
            if os.path.exists(pickle_path + "_raw_dat.pkl"):
                ...
                train, test = _input.SplitData(input1_path, input2_path, pickle_path, split_ratio, Decare_rounds, to_normalize, to_split)        
