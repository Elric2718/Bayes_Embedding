...
def configure_output_dir(d=None):
    ...
    if not osp.exists(G.output_dir):#, "Log dir %s already exists! Delete it first or use a different dir"%G.output_dir
        os.makedirs(G.output_dir)
    G.output_file = open(osp.join(G.output_dir, "log.txt"), 'a+')
