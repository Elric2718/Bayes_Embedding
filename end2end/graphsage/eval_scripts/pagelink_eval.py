...
def run_regression(train_embeds, train_labels, test_embeds, test_labels):
    ...
    #print(train_embeds.shape, train_labels[0], len(train_labels))
...
if __name__ == '__main__':
    ...
    print("Loading data...")
    G = json_graph.node_link_graph(json.load(open(dataset_dir + "/pagelink-G.json")))
    labels = json.load(open(dataset_dir + "/pagelink-class_map.json"))
